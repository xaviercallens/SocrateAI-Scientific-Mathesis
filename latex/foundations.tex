...
bookkeeping loses \emph{first}. A chain \textsf{B} → \textsf{B} → \textsf{L} is sound at every
direct edge and the head still rests on literature. Nobody checks the closure by eye, because
